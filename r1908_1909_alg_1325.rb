...
class R1908_1909_ALG_1325_RGRNInv
...
class R1908_1909_ALG_1325_LCRPInv
...
class R1908_1909_ALG_1325_LCRP_DNA
  class Parent_Key
  ...
  def processor(this_connection)
    ...
    @inbound_lines.each do |specline|
      ...
      if specline['Investigator'].strip != 'SMRT602092' and
          specline['Investigator'].strip != 'SMART'
        next
      end
  ...
  def writer(vendor)
    ...
    @processing_lines.each do |outline|
      ...
      site_id                 = key_line['SUBJECT_ID'][0..-4].rjust(6, '0')
