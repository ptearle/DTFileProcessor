    ...
    @processing_lines.each do |outline|
      ...
      values_clause <<
          " (#{outline['STUDYID'].insert_value}"                      + # study_protocol_id
              ...
              " #{outline['INVNAM'].insert_value}"                    + # site_name
              ' NULL,'                                                + # site_address
              ' NULL,'                                                + # site_city
              ' NULL,'                                                + # site_state
              ' NULL,'                                                + # site_country
              ...
              " #{outline['INVNAM'].insert_value}"                    + # site_PI
              ' NULL,'                                                + # site_PI_email
...
class R1500_HV_1214_subject
  ...
  def writer(vendor)
    ...
    @processing_lines.each do |outline|
      ...
      treatment           = 'REGN1500'.insert_value
